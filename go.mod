...
require (
	...
	github.com/m4ksio/silo-mev-protobuf-go v0.0.2
...
replace (
	...
	github.com/tendermint/tendermint => github.com/SiloMEV/sei-tendermint-prepare-fixed v0.0.0-20250119155532-85dcd3d2d6e5
